...
# r is the radius of respective cells
rA549=4.8
rAG1522=6.7
rHela=8.35
rNB1RGB=7.4
...
# Stopping potential and stopping potential during hypoxic conditions for respective cells
Se1= 100
Se1H=25
Se2=122
Se2H=17
...
####  CHO Cells ###
def func (n):
    return math.exp(-lalphaCHO*n) # Probability of cell survival

y = list(map(func,doseCHO))

def func (n):
    return math.exp(-lalphahypoxicCHO*n) # Probability of cell survival in Hypoxic conditions

c = list(map(func,doseCHO))

# Plotthing survival curve
plt.yscale('log')
...
def func (n):
    ...
    return math.exp(-lalphaHela*n) # Probability of cell survival

y = list(map(func,doseCommon))

def func (n):
    
    return math.exp(-lalphahypoxicHela*n) # Probability of cell survival in Hypoxic conditions
...
def func (n):
    ...
    return math.exp(-lalphaA549*n) # Probability of cell survival

y = list(map(func,doseCommon))

def func (n):
    
    return math.exp(-lalphahypoxicA549*n) # Probability of cell survival in Hypoxic conditions
...
#### AG1522 Cells ###
def func (n):
    return math.exp(-lalphaAG1522*n) # Probability of cell survival

y = list(map(func,doseCommon))

def func (n):
    return math.exp(-lalphahypoxicAG1522*n) # Probability of cell survival in Hypoxic conditions
...
#### NB1RGB Cells ###
def func (n):
    return math.exp(-lalphaNB1RG*n) # Probability of cell survival

y = list(map(func,doseCommon))
def func (n):
    
    return math.exp(-lalphahypoxicNB1RG*n) # Probability of cell survival in Hypoxic conditions
...
#### A17222 Cells ###
def func (n):
    return math.exp(-lalphaA1722*n) # Probability of cell survival

y = list(map(func,doseCommon))

def func (n):
    return math.exp(-lalphahypoxicA1722*n) # Probability of cell survival in Hypoxic conditions
...
#### For V79 Cells ###
def func (n):
    return math.exp(-lalphaV79*n) # Probability of cell survival

y = list(map(func,doseCommon))

def func (n):
    return math.exp(-lalphahypoxicV79*n) # Probability of cell survival in Hypoxic conditions
